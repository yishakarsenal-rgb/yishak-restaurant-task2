# 🍽️ Yishak Restaurant — Web Application

A modern, high-performance, and responsive web application built for **Yishak Restaurant**, celebrating authentic traditional Ethiopian cuisine with a seamless digital dining experience.
...
- **🖼️ Grid Media Gallery:** Responsive gallery displaying restaurant moments, traditional coffee ceremonies, and high-resolution food photography.
- **📅 Table Reservation Interface:** Clean reservation booking form for guests to reserve tables online.
...
├── app.js            # Cart logic, theme switcher, & menu filter handlers
└── assets/           # Dish & gallery image assets (cappuccino.jpg, etc.)
```
